...
@Module( {
  imports: [
    TypeOrmModule.forRoot( {
      ...
      host: 'dpg-cn9mh40cmk4c73a0um3g-a',
      port: 5432,
      username: 'liwondeprivatehostipal_user',
      password: '8lV0LuqZ7hrpqTUmwDUtqVkmlb5RF4tq',
      url: 'postgres://liwondeprivatehostipal_user:8lV0LuqZ7hrpqTUmwDUtqVkmlb5RF4tq@dpg-cn9mh40cmk4c73a0um3g-a/liwondeprivatehostipal',
      database: 'liwondeprivatehostipal',
